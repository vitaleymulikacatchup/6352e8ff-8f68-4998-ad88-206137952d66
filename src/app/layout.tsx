...
export const metadata: Metadata = {
  title: "F1 Racing Cars Presentation - Formula 1 Technology Showcase",
  description: "Comprehensive Formula 1 racing car presentation featuring advanced engineering, safety systems, hybrid power units, and cutting-edge motorsport technology.",
  keywords: ["Formula 1", "F1 cars", "racing technology", "motorsport engineering", "hybrid engines", "aerodynamics", "racing safety"],
  metadataBase: new URL("https://f1presentation.com"),
  alternates: {
    canonical: "https://f1presentation.com"
  },
  openGraph: {
    title: "F1 Racing Cars Presentation - Formula 1 Technology Showcase",
    description: "Explore the pinnacle of motorsport technology with our comprehensive F1 car presentation showcasing cutting-edge innovation and engineering excellence.",
    siteName: "F1 Presentation",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763623276361-gjdyewkm.jpg",
        alt: "Formula 1 racing car technology showcase"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "F1 Racing Cars Presentation - Formula 1 Technology",
    description: "Experience the pinnacle of motorsport technology with our comprehensive F1 car presentation.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34kFQ1mvageIxtFsoHwjFOCooyh/uploaded-1763623276361-gjdyewkm.jpg"]
  },
  robots: {
    index: true,
    follow: true
